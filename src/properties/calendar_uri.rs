...
impl CalendarURI {
    pub fn from_uri(uri: URI) -> CalendarURI {
        CalendarURI {
            typ:        None,
            media_type: None,
...
impl Display for CalendarURI {
    fn fmt(&self, f: &mut Formatter) -> Result<(), fmt::Error> {
        Property::fmt(self, f)
    }
}

impl Validated for CalendarURI {}

impl ValidatedWrapper for CalendarURI {
